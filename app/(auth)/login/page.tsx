  ...
  return (
    <Card>
      <CardHeader className="space-y-1 text-center">
        <CardTitle className="text-2xl uppercase">open your <span className="text-primary">account</span> </CardTitle>
      </CardHeader>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center">
            <span className="bg-background px-2 text-muted-foreground">
              Or <span className={cn(bold.className, "text-primary hover:underline")}>register</span>
            </span>
          </div>
        </div>
